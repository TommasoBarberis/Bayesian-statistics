...
Rien que en regardant l'intervalle de credibilite a priori [3.13; 9.77] sur le _mcmc0_ (sans les données) on remarque que il est beaucoup plus large que l'intervalle à posteriori [2.72; 2.94]. Cela veut dire qu'on a effectivement gagné de l'information.
